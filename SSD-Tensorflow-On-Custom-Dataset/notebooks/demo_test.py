...
# 导入新训练的模型参数
ckpt_filename = '/root/SSD-Tensorflow-On-Custom-Dataset/train_model/model.ckpt-3000'   # 注意xxx代表的数字是否和文件夹下的一致
...
# 主流程函数
def process_image(img, select_threshold=0.2, nms_threshold=.01, net_shape=(300, 300)):
...
# 测试的文件夹
path = '/root/SSD-Tensorflow-On-Custom-Dataset/demo/'
