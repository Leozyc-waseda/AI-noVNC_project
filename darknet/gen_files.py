...
classes=["arrow_left","singleP_left","doubleP_left","ground_right","turn_right","arrow_right"]
...
def convert_annotation(image_id):
    in_file = open('/root/darknet/VOCdevkit/VOC2007/Annotations/%s.xml' %image_id)
    out_file = open('/root/darknet/VOCdevkit/VOC2007/labels/%s.txt' %image_id, 'w')
